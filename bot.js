...
// --- Using Native USDC and corresponding pools ---
...
async function checkArbitrage() {
    ...
    try {
        ...
        // Assume WETH < Native USDC, so WETH=T0, USDC=T1
        ...
        try {
            ...
            // Pass parameters as an array within an array for the struct type
            simulatedIntermediateFromSwap1 = (await quoterContract.quoteExactInputSingle.staticCall(
                 [ // Array representing the struct argument
            ...
            ))[0]; // Get amountOut from result tuple
