  ...
  networks: {
    ...
    hardhat: {
      ...
      forking: {
       ...
       accounts: [], // Use empty array for default generated accounts
    },
    ...
    localFork: {
      ...
      // When connecting to an *already running* Hardhat node,
      // set accounts to "remote" to use the accounts generated by that node.
      accounts: "remote", // Corrected this line - always use remote accounts for the running node
