// config/index.js
// --- VERSION 1.7 --- Added handling for localFork RPC and FlashSwap address loading.
 ...
 */
function loadConfig() {
    logger.debug('[loadConfig v1.7] Starting loadConfig function...'); // Updated version log
    ...
    try {
        baseConfig.POOL_CONFIGS = loadPoolConfigs(
            networkMetadata.NAME, // Pass network name from metadata to poolLoader
...
try {
    ...
    const essentialKeys = ['NAME','CHAIN_ID','TOKENS','RPC_URLS','FLASH_SWAP_CONTRACT_ADDRESS', 'TITHE_WALLET_ADDRESS', 'MIN_PROFIT_THRESHOLDS','CHAINLINK_FEEDS','GAS_COST_ESTIMATES', 'POOL_CONFIGS', 'FINDER_SETTINGS', 'AAVE_FLASH_LOAN_FEE_BPS'];
