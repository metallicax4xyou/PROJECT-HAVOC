...
// --- VERSION 1.1 --- Corrected ABI path for compiled artifacts
...
// --- CORRECTED ABI PATH ---
// Require the FlashSwap contract artifact generated by Hardhat compilation.
// This contains the ABI needed to interact with the deployed contract.
// Path relative to the core/ directory: go up two levels (..) to the project root,
// then navigate into artifacts/contracts/FlashSwap.sol/FlashSwap.json
const FlashSwapArtifact = require('../../artifacts/contracts/FlashSwap.sol/FlashSwap.json');
// --- END CORRECTED ABI PATH ---
...
class FlashSwapManager {
    ...
    constructor(config, provider) {
        ...
        this.flashSwapABI = FlashSwapArtifact.abi;
